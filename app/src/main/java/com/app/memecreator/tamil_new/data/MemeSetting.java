...
public class MemeSetting implements Serializable {
    ...
    private int topBottomBorderSize = 0;
    ...
    public int getTopBottomBorderSize() {
        return topBottomBorderSize;
    }

    public void setTopBottomBorderSize(int topBottomBorderSize) {
